package com.promact.myapp.web.rest;
...
import com.promact.myapp.config.KafkaProperties;
...
class MyBookingApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        MyBookingApplicationKafkaResource kafkaResource = new MyBookingApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/my-booking-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/my-booking-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
