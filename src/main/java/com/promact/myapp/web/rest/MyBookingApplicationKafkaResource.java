...
@RestController
@RequestMapping("/api/my-booking-application-kafka")
public class MyBookingApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyBookingApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyBookingApplicationKafkaResource(KafkaProperties kafkaProperties) {
